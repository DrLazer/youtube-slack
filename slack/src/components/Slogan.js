...
function Slogan() {
  return (
    <div className="bg-fuchsia-900">
      <div className='m-auto margin: auto flex flex-col bg-fuchsia-900 pl-11 pb-10 max-w-[1230px] md:flex-row'>
        ...
        <div className='w-[30px] min-w-[20px]'>
        </div>
        <div className='min-w-[650px] flex items-center justify-center pt-6 overflow-hidden'>
